...
class MovieCategoryAdapter(
    private val onCategoryClick: (VodCategory) -> Unit
) : ListAdapter<VodCategory, MovieCategoryAdapter.CategoryViewHolder>(CategoryDiffCallback()) {
    ...
    class CategoryDiffCallback : DiffUtil.ItemCallback<VodCategory>() {
        override fun areItemsTheSame(oldItem: VodCategory, newItem: VodCategory): Boolean {
            return oldItem.categoryId == newItem.categoryId
        }
        
        override fun areContentsTheSame(oldItem: VodCategory, newItem: VodCategory): Boolean {
